...
| 4        | version       | 1      | Версия протокола (сейчас = 2)                 |
...
| 77       | signatureType | 1      | Тип подписи (1 = single, 2 = multi)           |
| 78       | signature     | 64     | Schnorr-подпись payload-а                     |
| 142      | dataLen       | 2      | Длина данных (в байтах)                       |
| 144      | data          | N      | Данные (CBOR, сжатые, возможно зашифрованные) |
